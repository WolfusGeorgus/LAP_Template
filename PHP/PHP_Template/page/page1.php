  ...
  <div class="m-3">
    ...
    <form method="post" action="functions/func1.php">
      <select class="form-select mb-2" name="select_person">
        ...
        <?php
          $conn = new Conn();
          $result = $conn->makeStatement("select per_id, concat(per_fname, ' ', per_lname) 'per_name' from person");
      ...
      <select class="form-select mb-2" name="select_company">
        ...
        <?php
          $result = $conn->makeStatement("select com_id, com_name from company");
...
<div class="card text-bg-light my-3">
  <?php makeTable("select per_id, concat(per_fname, ' ', per_lname) 'per_name', com_name from person left join company using(com_id)"); ?>
</div>